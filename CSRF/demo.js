// Taken directly from npmjs.com/package/express-session 
// For testing and demo purposes

// Step one: Verify that it works. OK 
// Step two: Understand how it works. Sure? OK?
// Step three: Extend with database functionality and update-password requests
// Step four: Verify CSRF-vulnerability
// ... Profit

// Next up: Mitigate CSRF-vulnerability, and experiment with noSQL+authentication-bypass
...
app.use(session({
  ...
  //sameSite: 'strict'  // Does not have any effect. Maybe because everything runs on localhost? IDK
}))
...
app.get('/', isAuthenticated, function (req, res) {
  ...
  // Maybe TODO: Also add some secret data for the user just for fun
})
...
async function getUser(username, con){
  ...
  console.log(`DEBUG: Preparing to execute query...`)
